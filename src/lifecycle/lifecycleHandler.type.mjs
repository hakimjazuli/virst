 ...
 * @property {(onViewCallback:import('./onViewPortHandler.type.mjs').onViewPortHandler["onViewPort"])=>import('./onViewPort.export.mjs').onViewPort} lifecycleHandler.onViewPort
 */
